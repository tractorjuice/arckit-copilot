...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/us-sbom-eo-14028-template.md`
...
6. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **SBOM** per-type checks pass. Fix any failures before proceeding.
