...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/us-icam-template.md`
...
6. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **ICAM** per-type checks pass. Fix any failures before proceeding.
