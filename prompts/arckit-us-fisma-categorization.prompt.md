...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/us-fisma-categorization-template.md`
...
7. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **FIPS199** per-type checks pass. Fix any failures before proceeding.
