...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/uae-procurement-template.md`
...
7. Populate the External References section per `.arckit/references/citation-instructions.md`. Federal Decree-Law No. 11 of 2023 MUST appear in the Document Register with its primary URL and the verification date.
8. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **FPRO** per-type checks pass. Fix any failures before proceeding.
