...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/us-nist-800-53-template.md`
...
7. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **NIST** per-type checks pass. Fix any failures before proceeding.
