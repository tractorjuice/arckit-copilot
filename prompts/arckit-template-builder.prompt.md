...
Extract the template type from `${input:topic:Enter project name or topic}`. If blank or vague, ask the user what kind of document template they want to create.
