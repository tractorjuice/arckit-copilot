...
1. **Determine integration scope**:
   ...
   Use the user's input and `${input:topic:Enter project name or topic}` to determine scope.
...
4. **Read the template** (with user override support):
   ...
   - **If not found**: Read `.arckit/templates/agent-integration-template.md` (default)
