...
- **Fallback**, `.arckit/templates/gcloud-clarify-template.md`
...
- **Referenced Documents** and **External References** — every requirement artefact and supplier service page the assessment drew on. Follow the citation instructions in `.arckit/references/citation-instructions.md`: inline citation markers next to claims taken from a supplier's page, and each source registered in the External References tables.
