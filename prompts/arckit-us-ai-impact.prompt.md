...
2. Read the template:
   ...
   - **Fallback**, `.arckit/templates/us-ai-impact-template.md`
...
6. Before writing the file, read `.arckit/references/quality-checklist.md` and verify all **Common Checks** plus the **AIIA** per-type checks pass. Fix any failures before proceeding.
